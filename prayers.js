/* BEFORE THE CLOSE — PRAYER DATABASE */

const prayers = {
    general: [
        {
            title: "Start With Purpose",
            text: "Lord, guide my words and actions. Help me serve people before I chase results, listen before I answer, and work with honesty and purpose. Amen."
        },
        {
            title: "The Next Conversation",
            text: "Lord, help me leave the last conversation behind. Give the next person my full energy, attention, and respect. Amen."
        },
        {
            title: "Rejection Is Not Defeat",
            text: "Lord, strengthen me when I hear no. Help me learn what I can, release what I cannot control, and keep moving without bitterness. Amen."
        },
        {
            title: "Serve Before You Sell",
            text: "Lord, keep my focus on the person in front of me. Help me understand their needs and recommend only what can genuinely help. Amen."
        },
        {
            title: "Confidence Without Arrogance",
            text: "Lord, give me confidence without pride. Let me speak clearly, stay teachable, and remember that strength and humility can exist together. Amen."
        },
        {
            title: "When Business Is Slow",
            text: "Lord, keep me disciplined in quiet hours. Help me prospect, prepare, follow up, and stay ready instead of waiting passively for opportunity. Amen."
        },
        {
            title: "Ask for the Sale",
            text: "Lord, give me courage to ask for the business when I have earned the opportunity. Keep fear of rejection from making me hesitant. Amen."
        },
        {
            title: "Control What I Can",
            text: "Lord, remind me that I cannot control every outcome. Help me own my effort, attitude, preparation, integrity, and next action. Amen."
        },
        {
            title: "Listen First",
            text: "Lord, slow me down enough to truly hear people. Help me understand the problem behind their words instead of rushing toward my pitch. Amen."
        },
        {
            title: "Stay Consistent",
            text: "Lord, give me discipline when motivation fades. Help me do the ordinary work repeatedly until it creates extraordinary results. Amen."
        },
        {
            title: "A Fresh Start",
            text: "Lord, help me begin again today. Keep yesterday's mistakes and victories from distracting me from the work in front of me. Amen."
        },
        {
            title: "Through the Objection",
            text: "Lord, give me patience when someone pushes back. Help me treat objections as something to understand, not a battle I need to win. Amen."
        },
        {
            title: "No Comparison",
            text: "Lord, keep me from measuring my worth against someone else's numbers. Help me compete with who I was yesterday and stay focused on my path. Amen."
        },
        {
            title: "Provide With Purpose",
            text: "Lord, remind me why I work hard. Let my goals become a way to build stability, provide for the people I love, and create a better future. Amen."
        },
        {
            title: "The Follow-Up",
            text: "Lord, give me discipline to follow through. Help me remember promises, return calls, and show people through consistency that my word matters. Amen."
        },
        {
            title: "Integrity Over Commission",
            text: "Lord, never let money become more important than doing what is right. Give me courage to tell the truth even when honesty costs me a sale. Amen."
        },
        {
            title: "Energy for the Room",
            text: "Lord, help me bring genuine energy into every conversation. Let people feel that I am present, prepared, and grateful for their time. Amen."
        },
        {
            title: "When I Feel Behind",
            text: "Lord, keep panic from controlling me when the numbers look bad. Help me return to fundamentals and focus on the next useful action. Amen."
        },
        {
            title: "The Difficult Customer",
            text: "Lord, give me patience in tense conversations. Help me stay professional, protect my boundaries, and refuse to return frustration with frustration. Amen."
        },
        {
            title: "Earn Their Trust",
            text: "Lord, help my words and actions match. Let trust grow because I am honest, dependable, and willing to put the customer's needs ahead of pressure. Amen."
        },
        {
            title: "One More Attempt",
            text: "Lord, when I am tempted to quit early, give me strength for one more meaningful attempt. Let persistence come from discipline, not desperation. Amen."
        },
        {
            title: "Learn From the Loss",
            text: "Lord, help me study lost opportunities without tearing myself down. Show me what to improve and what I simply need to release. Amen."
        },
        {
            title: "Grateful for the Opportunity",
            text: "Lord, thank You for another day to work, learn, meet people, and build. Let gratitude strengthen my attitude even when the results are imperfect. Amen."
        },
        {
            title: "Be Present",
            text: "Lord, keep my mind where my feet are. Help me give the person in front of me my attention instead of worrying about quotas or the next lead. Amen."
        },
        {
            title: "Finish Strong",
            text: "Lord, give me the energy to finish the day with professionalism. Help me treat the last opportunity with the same care as the first. Amen."
        },
        {
            title: "Courage to Begin",
            text: "Lord, when I overthink the first call or approach, help me simply begin. Let action create the momentum that fear tries to delay. Amen."
        },
        {
            title: "Patience With the Process",
            text: "Lord, help me work urgently without demanding instant results. Give me patience for seeds that need time while I continue planting new ones. Amen."
        },
        {
            title: "Speak With Clarity",
            text: "Lord, help me explain value simply and honestly. Give me wisdom to know what to say, what to ask, and when I have said enough. Amen."
        },
        {
            title: "Remember My Value",
            text: "Lord, remind me that today's numbers measure performance, not my worth. Help me pursue excellence without letting a scoreboard define me. Amen."
        },
        {
            title: "Before the Close",
            text: "Lord, before I chase the close, center me in faith, focus, and purpose. Help me serve well, work hard, stay honest, and trust the results to follow. Amen."
        }
    ],
    ...
    solar: [
        {
            title: "One More Door",
            text: "Lord, give me courage to knock the next door with fresh energy. Do not let the last rejection decide how I approach the next homeowner. Amen."
        },
        {
            title: "Serve the Homeowner",
            text: "Lord, help me understand the homeowner before I explain the solution. Let education, honesty, and service lead every conversation. Amen."
        },
        {
            title: "Reset and Knock",
            text: "Lord, when doors close quickly, help me reset without resentment. Give the next house the same confidence and respect as the first. Amen."
        },
        {
            title: "Do Not Prejudge the House",
            text: "Lord, keep me from deciding who will listen before I knock. Remind me that I cannot see someone's needs from the curb. Amen."
        },
        {
            title: "The Utility Bill",
            text: "Lord, give me patience to explain costs and savings clearly. Help me use real numbers honestly and never create fear just to force urgency. Amen."
        },
        {
            title: "Earn the Appointment",
            text: "Lord, help me create enough trust and curiosity to earn the next conversation. Give me confidence to ask for the appointment without pressure. Amen."
        },
        {
            title: "When They Say Not Interested",
            text: "Lord, keep me calm when I hear 'not interested.' Help me ask thoughtful questions, respect boundaries, and know when to move on. Amen."
        },
        {
            title: "Long Turf Day",
            text: "Lord, strengthen my body and attitude through long hours outside. Help me stay sharp, respectful, and grateful even when my feet are tired. Amen."
        },
        {
            title: "The Skeptical Homeowner",
            text: "Lord, give me patience with skepticism. Help me answer what I know, admit what I do not, and let transparency build credibility. Amen."
        },
        {
            title: "No-Shows",
            text: "Lord, when an appointment falls through, keep disappointment from becoming discouragement. Help me refill the pipeline instead of dwelling on one missed meeting. Amen."
        },
        {
            title: "Educate, Don't Pressure",
            text: "Lord, help me make complicated solar information understandable. Keep me focused on helping people make informed decisions rather than forcing quick ones. Amen."
        },
        {
            title: "The Next Driveway",
            text: "Lord, when I hesitate at the curb, give me courage to walk the driveway. Remind me that opportunity begins with taking the first step. Amen."
        },
        {
            title: "Weather the Day",
            text: "Lord, whether it is hot, cold, windy, or wet, help me keep a steady attitude. Give me wisdom to work safely and discipline to keep moving. Amen."
        },
        {
            title: "Protect Their Trust",
            text: "Lord, help me never promise savings, timelines, or outcomes I cannot guarantee. Let my reputation be worth more than one commission. Amen."
        },
        {
            title: "Stay Off Autopilot",
            text: "Lord, keep me from repeating a script without listening. Help every homeowner feel like a person, not another door on my route. Amen."
        },
        {
            title: "After a Rough Block",
            text: "Lord, when an entire street feels dead, help me leave it without carrying the frustration forward. Give me a clean mind for the next block. Amen."
        },
        {
            title: "Ask Better Questions",
            text: "Lord, help me learn how the homeowner uses energy, what concerns them, and what matters most before I offer an answer. Amen."
        },
        {
            title: "Believe in the Value",
            text: "Lord, give me confidence in the value I can explain honestly. Let belief make me clear and calm rather than aggressive. Amen."
        },
        {
            title: "The Decision Maker",
            text: "Lord, help me respect everyone involved in the household decision. Give me patience to include the right people instead of rushing around them. Amen."
        },
        {
            title: "Appointment Day",
            text: "Lord, prepare me to show up organized, punctual, and ready. Let the homeowner feel that their time and questions matter. Amen."
        },
        {
            title: "When the Numbers Don't Work",
            text: "Lord, give me integrity when solar is not the right fit. Help me say so honestly and leave the relationship better than I found it. Amen."
        },
        {
            title: "Follow Up With Purpose",
            text: "Lord, help me follow up without becoming a nuisance. Give me timing, patience, and something useful to bring back to the conversation. Amen."
        },
        {
            title: "Stay Humble After a Win",
            text: "Lord, when I close a strong deal, keep me grateful and grounded. Help me celebrate without losing the hunger to serve the next person well. Amen."
        },
        {
            title: "Do Not Chase the Commission",
            text: "Lord, keep my eyes on the customer's situation before my paycheck. Help me build a career that lasts because people can trust me. Amen."
        },
        {
            title: "The Homeowner Who Needs Time",
            text: "Lord, give me patience when someone needs to think. Help me answer their concerns, set a clear next step, and respect their pace. Amen."
        },
        {
            title: "Knock With Confidence",
            text: "Lord, steady my voice, posture, and mind before I knock. Help me be warm, direct, and comfortable enough to be myself. Amen."
        },
        {
            title: "A Better Tomorrow",
            text: "Lord, when today falls short of goal, help me review it honestly and prepare for tomorrow instead of carrying shame home. Amen."
        },
        {
            title: "Protect the Reputation",
            text: "Lord, help my work reflect well on my team and industry. Let my honesty challenge the distrust people may already have about solar sales. Amen."
        },
        {
            title: "One Conversation Can Change the Day",
            text: "Lord, when the board is empty, remind me that the day is not finished. Give me enough faith and focus for the next real conversation. Amen."
        },
        {
            title: "Light With Purpose",
            text: "Lord, as I talk about energy and savings, keep my own purpose clear. Help me bring useful information, honest service, and steady hope to every door. Amen."
        }
    ],
    ...
    cars: [
        {
            ...
            text: "Lord, help me greet every person on the lot with respect instead of judging whether they will buy. Amen."
        },
        {
            title: "Needs Before Numbers",
            text: "Lord, help me understand what the customer needs before I focus on price, payment, or commission. Amen."
        },
        {
            title: "The Test Drive",
            text: "Lord, help me use the test drive to listen and learn. Let me notice what matters to the customer instead of filling every silence. Amen."
        },
        {
            title: "Build the Trust",
            text: "Lord, give me patience to earn trust in an industry where customers may arrive guarded or skeptical. Amen."
        },
        {
            title: "Slow Lot, Ready Mind",
            text: "Lord, keep me productive when traffic is slow. Help me follow up, learn inventory, and prepare for the next opportunity. Amen."
        },
        {
            title: "The Trade-In",
            text: "Lord, help me handle trade-in conversations with clarity and respect. Keep me from taking frustration personally when expectations differ. Amen."
        },
        {
            title: "Payment Conversation",
            text: "Lord, give me wisdom to discuss budgets and payments honestly. Help me avoid pushing someone beyond what is healthy for them. Amen."
        },
        {
            title: "Financing Frustration",
            text: "Lord, when financing becomes difficult, help me stay calm and compassionate. Let me focus on options rather than embarrassment or pressure. Amen."
        },
        {
            title: "The Walkaround",
            text: "Lord, help me know the product well enough to explain what matters, not just recite features. Amen."
        },
        {
            title: "After the Be-Back",
            text: "Lord, give me discipline to follow up with people who leave. Help me be useful and persistent without becoming pushy. Amen."
        },
        {
            title: "The Price Objection",
            text: "Lord, help me understand what is behind the objection before I defend the number. Give me patience to create clarity. Amen."
        },
        {
            title: "Another Salesperson's Deal",
            text: "Lord, keep jealousy out of my heart when a coworker closes. Help me learn, congratulate them, and stay ready for my opportunity. Amen."
        },
        {
            title: "The Upside-Down Trade",
            text: "Lord, give me compassion when a customer's financial situation is difficult. Help me explain reality without judgment. Amen."
        },
        {
            title: "A Family's Vehicle",
            text: "Lord, remind me that this purchase may carry children, groceries, work tools, and memories. Help me take their decision seriously. Amen."
        },
        {
            title: "Inventory Limits",
            text: "Lord, when the perfect vehicle is not on the lot, give me creativity and honesty in finding the best available path. Amen."
        },
        {
            title: "The Negotiation",
            text: "Lord, keep me calm when numbers move back and forth. Help me protect value while treating the customer like a partner, not an opponent. Amen."
        },
        {
            title: "Delivery Day",
            text: "Lord, help me make delivery feel as important as the sale. Let me explain the vehicle, answer questions, and finish the experience well. Amen."
        },
        {
            title: "After a Lost Deal",
            text: "Lord, help me learn from the customer who buys elsewhere without becoming bitter. Show me what I can improve. Amen."
        },
        {
            title: "Product Knowledge",
            text: "Lord, give me discipline to know my inventory, trims, features, and differences so my confidence is earned. Amen."
        },
        {
            title: "The Phone Lead",
            text: "Lord, help me treat a phone or internet lead like a real person, not a name on a screen. Give me a reason to earn their visit. Amen."
        },
        {
            title: "End of Month",
            text: "Lord, when pressure rises near month-end, keep my integrity steady. Help urgency sharpen my effort without changing my values. Amen."
        },
        {
            title: "The Difficult Negotiator",
            text: "Lord, give me patience with someone who challenges every detail. Help me stay respectful and avoid making the conversation personal. Amen."
        },
        {
            title: "Ask for Commitment",
            text: "Lord, when I have helped someone find the right vehicle, give me confidence to ask for the business clearly. Amen."
        },
        {
            title: "Protect the Customer Experience",
            text: "Lord, help me remember that people may forget the numbers but remember how I treated them. Amen."
        },
        {
            title: "Long Saturday",
            text: "Lord, give me stamina through the long dealership day. Help me stay engaged even when I am tired. Amen."
        },
        {
            title: "The First-Time Buyer",
            text: "Lord, give me patience with someone buying their first vehicle. Help me explain the process without making them feel inexperienced. Amen."
        },
        {
            title: "Repeat Business",
            text: "Lord, help me build relationships worthy of another purchase years from now, not just today's signature. Amen."
        },
        {
            title: "Referral Worthy",
            text: "Lord, let my service be good enough that customers feel comfortable sending friends and family to me. Amen."
        },
        {
            title: "Know When to Pause",
            text: "Lord, give me wisdom to know when another pitch helps and when space is the better service. Amen."
        },
        {
            title: "Keys With Purpose",
            text: "Lord, as I help people choose vehicles, keep me grounded in honesty, patience, and gratitude for every opportunity. Amen."
        }
    ],

    realestate: [
        {
            title: "Guide Them Home",
            text: "Lord, help me remember that behind every showing is someone's hope for home. Amen."
        },
        {
            title: "The First Showing",
            text: "Lord, give me patience to learn what my clients actually want rather than assuming I already know. Amen."
        },
        {
            title: "The Listing Appointment",
            text: "Lord, help me arrive prepared, speak honestly about the market, and earn trust without promising what I cannot control. Amen."
        },
        {
            title: "When the Offer Loses",
            text: "Lord, comfort my clients and steady me when an offer is rejected. Help us learn, adjust, and continue. Amen."
        },
        {
            title: "The Inspection",
            text: "Lord, give me calm when inspections uncover problems. Help me separate serious issues from fear and guide the conversation wisely. Amen."
        },
        {
            title: "The Appraisal",
            text: "Lord, when value is questioned, help me respond with facts, patience, and professionalism rather than panic. Amen."
        },
        {
            title: "Difficult Negotiations",
            text: "Lord, give me wisdom to advocate strongly without turning the other side into an enemy. Amen."
        },
        {
            title: "The Anxious Buyer",
            text: "Lord, help me bring calm to clients making a huge decision. Let my confidence come from preparation, not pressure. Amen."
        },
        {
            title: "The Emotional Seller",
            text: "Lord, give me empathy for people leaving homes filled with memories. Help me respect the emotion behind the transaction. Amen."
        },
        {
            title: "Follow Up Again",
            text: "Lord, give me discipline to nurture relationships that may take months or years to become business. Amen."
        },
        {
            title: "Pipeline Patience",
            text: "Lord, help me work faithfully through a long sales cycle without demanding instant results. Amen."
        },
        {
            title: "The Open House",
            text: "Lord, help me welcome every visitor warmly and stay curious about the opportunity in front of me. Amen."
        },
        {
            title: "Pricing Honestly",
            text: "Lord, give me courage to tell sellers what the market supports even when the truth is not what they hoped to hear. Amen."
        },
        {
            title: "Multiple Offers",
            text: "Lord, give me clarity when competition is high. Help me explain options and risks without creating unnecessary panic. Amen."
        },
        {
            title: "The Quiet Market",
            text: "Lord, keep me active when transactions slow. Help me prospect, learn, market, and serve instead of waiting. Amen."
        },
        {
            title: "The Hot Market",
            text: "Lord, when everything moves quickly, keep me careful. Help speed never replace due diligence. Amen."
        },
        {
            title: "A Client's Budget",
            text: "Lord, help me respect the limits my clients set. Keep me from pushing them toward a payment that steals their peace. Amen."
        },
        {
            title: "The Closing Table",
            text: "Lord, thank You for the work that brought everyone here. Help me finish details carefully and celebrate the people I served. Amen."
        },
        {
            title: "Deal Falls Apart",
            text: "Lord, when a transaction collapses late, give me patience and resilience. Help me protect my clients and find the next path. Amen."
        },
        {
            title: "The Referral",
            text: "Lord, help me treat every referral as borrowed trust that must be earned again. Amen."
        },
        {
            title: "Know the Market",
            text: "Lord, give me discipline to study neighborhoods, inventory, contracts, and trends so my advice has substance. Amen."
        },
        {
            title: "The Hard Conversation",
            text: "Lord, give me courage to deliver bad news clearly and compassionately instead of avoiding it. Amen."
        },
        {
            title: "Protect Their Confidence",
            text: "Lord, help me be steady when my clients feel uncertain. Let me offer facts, options, and calm. Amen."
        },
        {
            title: "No Comparison",
            text: "Lord, keep me from comparing my closings, listings, or social media presence to another agent's highlight reel. Amen."
        },
        {
            title: "Prospect With Purpose",
            text: "Lord, help me reach out to people with something useful to offer rather than treating every relationship as a lead. Amen."
        },
        {
            title: "Home, Not Just Property",
            text: "Lord, remind me that square footage and price are only part of the story. People are choosing where life will happen. Amen."
        },
        {
            title: "Serve Both Sides Fairly",
            text: "Lord, help me honor my responsibilities, disclose what must be disclosed, and never let a commission weaken my ethics. Amen."
        },
        {
            title: "The Next Contract",
            text: "Lord, when I am discouraged, help me keep doing the work that creates the next opportunity. Amen."
        },
        {
            title: "Grateful for the Keys",
            text: "Lord, let every set of keys remind me that trust was placed in my hands. Amen."
        },
        {
            title: "Foundation of Trust",
            text: "Lord, help me build my business the same way a good home is built: on a foundation strong enough to last. Amen."
        }
    ],
    ...
    insurance: [
        {
            ...
            text: "Lord, help me remember that policies represent homes, families, health, income, and futures people want protected. Amen."
        },
        {
            title: "The Next Call",
            text: "Lord, give me courage to make the next call with patience and confidence. Amen."
        },
        {
            title: "Persistence Without Pressure",
            text: "Lord, help me follow up faithfully without making people feel cornered. Amen."
        },
        {
            title: "Explain It Clearly",
            text: "Lord, give me simple words for complicated coverage. Help people understand what they are choosing. Amen."
        },
        {
            title: "The Hard What-If",
            text: "Lord, give me sensitivity when discussing accidents, illness, death, loss, and other difficult possibilities. Amen."
        },
        {
            title: "Coverage Before Commission",
            text: "Lord, keep me focused on appropriate protection rather than the biggest premium. Amen."
        },
        {
            title: "The Price Objection",
            text: "Lord, help me understand budget concerns and explain value honestly without using fear. Amen."
        },
        {
            title: "The Renewal",
            text: "Lord, help me treat existing clients with the same care I give new prospects. Amen."
        },
        {
            title: "The Claim Story",
            text: "Lord, when someone has experienced loss, help me listen with empathy and never reduce their pain to a sales example. Amen."
        },
        {
            title: "Earn the Trust",
            text: "Lord, help me be worthy of the personal information and financial trust clients share with me. Amen."
        },
        {
            title: "The Cold Call",
            text: "Lord, steady my voice before I dial. Help me be respectful of people's time and clear about why I am calling. Amen."
        },
        {
            title: "When They Already Have Coverage",
            text: "Lord, help me ask thoughtful questions instead of assuming there is nothing I can offer. Amen."
        },
        {
            title: "The Family Conversation",
            text: "Lord, help me discuss protection in a way that honors the people my client loves rather than manipulating their fears. Amen."
        },
        {
            title: "Know the Product",
            text: "Lord, give me discipline to understand exclusions, limits, riders, and details before I recommend anything. Amen."
        },
        {
            title: "Admit What I Don't Know",
            text: "Lord, give me humility to say I need to verify an answer rather than guessing. Amen."
        },
        {
            title: "The Follow-Up Date",
            text: "Lord, help me keep the commitments I make and contact people when I said I would. Amen."
        },
        {
            title: "After the No",
            text: "Lord, keep rejection from hardening me. Help me stay warm, professional, and ready for the next conversation. Amen."
        },
        {
            title: "The Referral Call",
            text: "Lord, help me honor the trust behind every introduction and never take a referral for granted. Amen."
        },
        {
            title: "A Better Fit",
            text: "Lord, give me wisdom to recognize when another option is better for the client, even if it earns me less. Amen."
        },
        {
            title: "Long-Term Service",
            text: "Lord, help me build relationships that last beyond enrollment or signature. Amen."
        },
        {
            title: "The Busy Prospect",
            text: "Lord, give me patience with people who are distracted or rushed. Help me make the conversation useful and concise. Amen."
        },
        {
            title: "The Detail That Matters",
            text: "Lord, keep me attentive to small details that could become important when coverage is needed. Amen."
        },
        {
            title: "No Fear Selling",
            text: "Lord, help me explain risk honestly without exaggerating danger to force a decision. Amen."
        },
        {
            title: "Protect My Reputation",
            text: "Lord, let every policy I write strengthen a reputation for clarity, care, and integrity. Amen."
        },
        {
            title: "The Uncomfortable Budget",
            text: "Lord, help me discuss money without judgment. Give me creativity in finding responsible options. Amen."
        },
        {
            title: "The Decision Takes Time",
            text: "Lord, give me patience when people need time to review coverage with family or advisors. Amen."
        },
        {
            title: "The Daily Numbers",
            text: "Lord, help me use goals as direction, not as permission to treat people like statistics. Amen."
        },
        {
            title: "When I Feel Burned Out",
            text: "Lord, renew my patience and remind me why protection work matters. Amen."
        },
        {
            title: "Be There After the Sale",
            text: "Lord, help me remain helpful when the commission is already earned and the client simply needs service. Amen."
        },
        {
            title: "A Shield of Service",
            text: "Lord, let my work today help people build protection with understanding, dignity, and peace. Amen."
        }
    ],
    ...
    cellular: [
        {
            ...
            text: "Lord, help me understand what each customer actually needs before I recommend a device or plan. Amen."
        },
        {
            title: "Ask the Right Questions",
            text: "Lord, give me curiosity about how people use their phones, what they pay, and what problems they need solved. Amen."
        },
        {
            title: "The Upgrade",
            text: "Lord, help me make upgrades about real value rather than simply moving a device. Amen."
        },
        {
            title: "The Accessory Conversation",
            text: "Lord, give me confidence to recommend useful protection and accessories without piling on things people do not need. Amen."
        },
        {
            title: "The Angry Customer",
            text: "Lord, give me patience when someone arrives frustrated by a bill, device, or previous experience. Amen."
        },
        {
            title: "The Long Transfer",
            text: "Lord, help me stay calm when systems, ports, or activations take longer than expected. Amen."
        },
        {
            title: "The Slow Store",
            text: "Lord, keep me productive when traffic is light. Help me learn, clean up follow-ups, and stay ready. Amen."
        },
        {
            title: "The Rush",
            text: "Lord, when customers arrive all at once, give me focus to serve each person accurately without making them feel rushed. Amen."
        },
        {
            title: "Explain the Bill",
            text: "Lord, help me make confusing charges understandable and be honest when I need to research an answer. Amen."
        },
        {
            title: "The Family Plan",
            text: "Lord, give me patience to understand multiple lines, needs, budgets, and personalities in one conversation. Amen."
        },
        {
            title: "Prepaid or Postpaid",
            text: "Lord, help me recommend the option that fits the customer instead of forcing everyone into the same solution. Amen."
        },
        {
            title: "The Trade-In",
            text: "Lord, help me explain value, condition requirements, and promotions clearly so there are no surprises. Amen."
        },
        {
            title: "The Promotion",
            text: "Lord, keep me from overselling fine print. Help me explain eligibility and timing honestly. Amen."
        },
        {
            title: "The Older Customer",
            text: "Lord, give me patience to teach technology without making anyone feel foolish. Amen."
        },
        {
            title: "The Tech-Savvy Customer",
            text: "Lord, keep me humble when a customer knows more about a feature than I do. Help me learn rather than become defensive. Amen."
        },
        {
            title: "The Protection Plan",
            text: "Lord, help me explain risk and coverage clearly without using fear. Amen."
        },
        {
            title: "Hit the Goal Right",
            text: "Lord, when quotas are heavy, keep my ethics heavier. Help me reach goals through better conversations, not bad recommendations. Amen."
        },
        {
            title: "The Next Transaction",
            text: "Lord, help me reset after a difficult interaction and greet the next customer with fresh energy. Amen."
        },
        {
            title: "The Return",
            text: "Lord, give me professionalism when someone comes back unhappy. Help me solve what I can and explain limits respectfully. Amen."
        },
        {
            title: "Learn the Devices",
            text: "Lord, give me discipline to know the products I sell so my recommendations have real value. Amen."
        },
        {
            title: "The Business Customer",
            text: "Lord, help me recognize when a customer's needs go beyond one phone and ask questions that uncover the bigger picture. Amen."
        },
        {
            title: "The Customer in a Hurry",
            text: "Lord, help me be efficient without skipping important explanations or details. Amen."
        },
        {
            title: "The Customer Who Wants Cheapest",
            text: "Lord, help me respect their budget and still explain tradeoffs clearly. Amen."
        },
        {
            title: "The Customer Who Wants Best",
            text: "Lord, help me separate useful premium features from expensive extras that do not serve them. Amen."
        },
        {
            title: "A Clean Handoff",
            text: "Lord, when another team or support channel must help, let me explain the next step clearly instead of passing frustration along. Amen."
        },
        {
            title: "The Follow-Up",
            text: "Lord, help me remember customers who asked me to check inventory, promotions, or account options. Amen."
        },
        {
            title: "Protect Their Data",
            text: "Lord, remind me that devices contain private lives. Help me handle information carefully and respectfully. Amen."
        },
        {
            title: "The Commission",
            text: "Lord, keep me grateful for what I earn but never let commission become more important than trust. Amen."
        },
        {
            title: "End of Shift",
            text: "Lord, help me finish the final customer with patience even when I am ready to go home. Amen."
        },
        {
            title: "Connection With Purpose",
            text: "Lord, as I sell technology that connects people, help my own conversations be patient, human, and honest. Amen."
        }
    ],

    d2d: [
        {
            title: "Knock the Next Door",
            text: "Lord, give me courage to walk the next driveway and knock with fresh confidence. Amen."
        },
        {
            title: "Thick Skin, Soft Heart",
            text: "Lord, help rejection bounce off my confidence without hardening the way I treat people. Amen."
        },
        {
            title: "Keep Walking",
            text: "Lord, when my legs are tired and my mind wants to quit, give me strength for the next house. Amen."
        },
        {
            title: "Do Not Prejudge",
            text: "Lord, keep me from deciding who will listen based on a yard, car, neighborhood, or front door. Amen."
        },
        {
            title: "The First Knock",
            text: "Lord, help me stop overthinking and start moving. Let the first door create momentum for the day. Amen."
        },
        {
            title: "The Quick No",
            text: "Lord, help me accept a fast rejection without carrying it to the next porch. Amen."
        },
        {
            title: "The Conversation at the Door",
            text: "Lord, give me presence to listen instead of racing through my pitch. Amen."
        },
        {
            title: "Respect the Boundary",
            text: "Lord, help me recognize when persistence is useful and when respect means thanking someone and leaving. Amen."
        },
        {
            title: "Long Block",
            text: "Lord, give me endurance when the street feels endless and results feel far away. Amen."
        },
        {
            title: "Bad Weather",
            text: "Lord, help me work wisely and safely when the weather makes the day harder. Amen."
        },
        {
            title: "The Dog Barking",
            text: "Lord, keep me calm, aware, and respectful when a home feels chaotic before the door even opens. Amen."
        },
        {
            title: "The Skeptic",
            text: "Lord, give me patience with people who distrust door-to-door sales. Help my behavior earn credibility. Amen."
        },
        {
            title: "The Slammed Door",
            text: "Lord, keep me from taking disrespect home with me. Help me release it and move forward. Amen."
        },
        {
            title: "One Good Conversation",
            text: "Lord, when the day is rough, remind me that one real conversation can change the energy of everything. Amen."
        },
        {
            title: "Stay Human",
            text: "Lord, keep me from turning houses into numbers. Help me remember that every door belongs to a person with their own day happening. Amen."
        },
        {
            title: "The Pitch",
            text: "Lord, help me know my message well enough that I can speak naturally instead of hiding behind memorized words. Amen."
        },
        {
            title: "Read the Room",
            text: "Lord, give me wisdom to notice tone, body language, interest, and discomfort so I can adjust respectfully. Amen."
        },
        {
            title: "The Appointment",
            text: "Lord, give me confidence to ask for the next step clearly when the conversation has earned it. Amen."
        },
        {
            title: "The No-Show",
            text: "Lord, when someone misses an appointment, help me reset quickly and keep building the pipeline. Amen."
        },
        {
            title: "The Team Board",
            text: "Lord, keep me motivated by the scoreboard without letting someone else's results make me desperate or jealous. Amen."
        },
        {
            title: "The Hot Streak",
            text: "Lord, when the yeses come easily, keep me humble, focused, and consistent. Amen."
        },
        {
            title: "The Cold Streak",
            text: "Lord, when nothing seems to work, help me examine my approach without losing belief in myself. Amen."
        },
        {
            title: "Water and Rest",
            text: "Lord, remind me that discipline includes taking care of my body so I can work safely and effectively. Amen."
        },
        {
            title: "The Last Hour",
            text: "Lord, give me focus when daylight, energy, or time is running out. Help me finish intentionally, not recklessly. Amen."
        },
        {
            title: "Smile Again",
            text: "Lord, after a rude interaction, help me give the next person a genuine smile instead of leftover frustration. Amen."
        },
        {
            title: "Walk With Confidence",
            text: "Lord, steady my posture, pace, voice, and mind as I approach each home. Amen."
        },
        {
            title: "Learn the Turf",
            text: "Lord, help me pay attention to patterns, conversations, and lessons in the neighborhood instead of moving blindly. Amen."
        },
        {
            title: "Go Home Proud",
            text: "Lord, whether the numbers are high or low, help me finish knowing I worked honestly and gave real effort. Amen."
        },
        {
            title: "One More Door",
            text: "Lord, when I am ready to call it, give me wisdom and, when appropriate, courage for one more door. Amen."
        },
        {
            title: "At the Threshold",
            text: "Lord, every doorstep is a new beginning. Help me arrive with courage, respect, purpose, and no baggage from the door before. Amen."
        }
    ],
    ...
    b2b: [
        {
            ...
            text: "Lord, help me understand the business problem before I offer a solution. Amen."
        },
        {
            title: "Ask Better Questions",
            text: "Lord, give me curiosity strong enough to uncover what the prospect actually needs. Amen."
        },
        {
            title: "The Cold Call",
            text: "Lord, steady my voice and help me earn a few useful seconds with clarity and respect. Amen."
        },
        {
            title: "The Gatekeeper",
            text: "Lord, help me treat every person in the organization with dignity instead of seeing them as an obstacle. Amen."
        },
        {
            title: "The Decision Maker",
            text: "Lord, give me confidence to speak with leaders without pretending to know what I have not learned. Amen."
        },
        {
            title: "The Discovery Call",
            text: "Lord, help me listen for priorities, pain, risk, timing, and the cost of doing nothing. Amen."
        },
        {
            title: "The Demo",
            text: "Lord, keep me focused on relevant outcomes instead of showing every feature I know. Amen."
        },
        {
            title: "The Proposal",
            text: "Lord, help me make the value, scope, expectations, and next steps clear enough to build confidence. Amen."
        },
        {
            title: "The Long Sales Cycle",
            text: "Lord, give me patience with opportunities that require months of trust and multiple stakeholders. Amen."
        },
        {
            title: "The Follow-Up",
            text: "Lord, help me follow up with purpose and new value instead of sending empty 'just checking in' messages. Amen."
        },
        {
            title: "No Response",
            text: "Lord, when emails and calls go unanswered, keep me persistent without becoming intrusive. Amen."
        },
        {
            title: "Procurement",
            text: "Lord, give me patience when process and paperwork slow momentum. Help me stay accurate and professional. Amen."
        },
        {
            title: "Legal Review",
            text: "Lord, when contracts move slowly, help me manage expectations and keep communication clear. Amen."
        },
        {
            title: "Budget Season",
            text: "Lord, give me wisdom to understand timing and help prospects plan instead of forcing decisions that do not fit. Amen."
        },
        {
            title: "The Champion",
            text: "Lord, help me equip the person who believes in the solution to communicate its value inside their organization. Amen."
        },
        {
            title: "Multiple Stakeholders",
            text: "Lord, give me patience to understand what success means to each person involved. Amen."
        },
        {
            title: "The Competitor",
            text: "Lord, keep me from attacking another company. Help me explain our differences with facts and confidence. Amen."
        },
        {
            title: "The Price Pressure",
            text: "Lord, help me protect value without becoming defensive when the conversation turns to cost. Amen."
        },
        {
            title: "The Lost Deal",
            text: "Lord, show me what to learn when a competitor wins. Keep me professional enough to preserve the relationship. Amen."
        },
        {
            title: "Pipeline Discipline",
            text: "Lord, help me keep prospecting even when current opportunities look promising. Amen."
        },
        {
            title: "Forecast Honestly",
            text: "Lord, give me courage to report the pipeline as it is, not as I wish it were. Amen."
        },
        {
            title: "The Executive Meeting",
            text: "Lord, help me be concise, prepared, and focused on business outcomes when time is limited. Amen."
        },
        {
            title: "The Technical Question",
            text: "Lord, give me humility to bring in expertise rather than bluffing an answer. Amen."
        },
        {
            title: "The Renewal",
            text: "Lord, help me prove value after the initial sale and treat retention as seriously as acquisition. Amen."
        },
        {
            title: "Expansion Opportunity",
            text: "Lord, help me notice where more value can genuinely be created without forcing unnecessary scope. Amen."
        },
        {
            title: "Relationship Over Transaction",
            text: "Lord, remind me that today's contact may become tomorrow's client, partner, referral, or teacher. Amen."
        },
        {
            title: "Protect Their Time",
            text: "Lord, help me arrive prepared, run useful meetings, and never waste a prospect's calendar. Amen."
        },
        {
            title: "Close the Next Step",
            text: "Lord, give me confidence to end conversations with a clear, mutually understood next action. Amen."
        },
        {
            title: "Build the Reputation",
            text: "Lord, let every email, call, meeting, and promise strengthen my reputation for reliability. Amen."
        },
        {
            title: "Business With Purpose",
            text: "Lord, help me create value that is real, relationships that are honest, and results I can be proud to stand behind. Amen."
        }
    ]
